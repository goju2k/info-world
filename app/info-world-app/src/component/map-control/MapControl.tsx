...
export function MapControl({
  ...
  return (
    <>
      {control3d && (
        <MapControlWrapper positionHorizontal='center' positionVertical='top'>
          <TopMessage>Click to control / ESC to exit</TopMessage>
          <TopMessage>Use Mouse and / W / S / A / D keys</TopMessage>
        </MapControlWrapper>
      )}
